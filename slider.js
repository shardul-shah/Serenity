function adjustVolume(newSliderValue, soundType) {
	...
	if (soundType == "rain") {
		...
		if (rain_mute_icon.getAttribute('src') == "images/mute_icon.png") //if sound is muted (volume = 0)
		...
		if (forest_mute_icon.getAttribute('src') == "images/mute_icon.png") //if sound is muted (volume = 0)
		...
		if (wind_mute_icon.getAttribute('src') == "images/mute_icon.png") //if sound is muted (volume = 0)
		...
		if (fire_mute_icon.getAttribute('src') == "images/mute_icon.png") //if sound is muted (volume = 0)
		...
		if (thunder_mute_icon.getAttribute('src') == "images/mute_icon.png") //if sound is muted (volume = 0)
