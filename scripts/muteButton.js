...
function toggleMute(soundType) {
	...
	if (soundType == "rain") {
		...
		if (rain_mute_icon.className == "fas fa-volume-up mute_icon") {
		...
		else if (rain_mute_icon.className == "fas fa-volume-mute mute_icon" && rain_volume == 0) {
		...
		if (ocean_mute_icon.className == "fas fa-volume-up mute_icon") {
		...
		//case of slider manually being put to 0 and then sound being unmuted
		else if (ocean_mute_icon.className == "fas fa-volume-mute mute_icon" && ocean_volume == 0) {
		...
		// if ocean sound is currently muted (and thus speaker icon is being displayed), and the speaker icon is clicked...
		// unmute the sound to the volume it was before (stored in var ocean_volume), and adjust the slider back to where it was before
		// and change the icon currently displayed to mute 
		else {
			ocean_mute_icon.className = "fas fa-volume-up mute_icon";
		...
		if (forest_mute_icon.className == "fas fa-volume-up mute_icon") {
		...
		//case of slider manually being put to 0 and then sound being unmuted
		else if (forest_mute_icon.className == "fas fa-volume-mute mute_icon" && forest_volume == 0) {
		...
		// unmute the sound to the volume it was before (stored in var forest_volume), and adjust the slider back to where it was before
		// and change the icon currently displayed to mute 
		else {
			forest_mute_icon.className = "fas fa-volume-up mute_icon";
		...
		if (wind_mute_icon.className == "fas fa-volume-up mute_icon") {
		...
		//case of slider manually being put to 0 and then sound being unmuted
		else if (wind_mute_icon.className == "fas fa-volume-mute mute_icon" && wind_volume == 0) {
		...
		// unmute the sound to the volume it was before (stored in var wind_volume), and adjust the slider back to where it was before
		// and change the icon currently displayed to mute 
		else {
			wind_mute_icon.className = "fas fa-volume-up mute_icon";
		...
		if (fire_mute_icon.className == "fas fa-volume-up mute_icon") {
		...
		//case of slider manually being put to 0 and then sound being unmuted
		else if (fire_mute_icon.className == "fas fa-volume-mute mute_icon" && fire_volume == 0) {
		...
		// unmute the sound to the volume it was before (stored in var fire_volume), and adjust the slider back to where it was before
		// and change the icon currently displayed to mute 
		else {
			fire_mute_icon.className = "fas fa-volume-up mute_icon";
		...
		if (thunder_mute_icon.className == "fas fa-volume-up mute_icon") {
		...
		//case of slider manually being put to 0 and then sound being unmuted
		else if (thunder_mute_icon.className == "fas fa-volume-mute mute_icon" && thunder_volume == 0) {
		...
		// unmute the sound to the volume it was before (stored in var thunder_volume), and adjust the slider back to where it was before
		// and change the icon currently displayed to mute 
		else {
			thunder_mute_icon.className = "fas fa-volume-up mute_icon";
...
/* 
IMPORTANT: the following is a small bug which made me stuck for a long time, when I initially had the mute and unmute button as images,
and was replacing the images instead of the fontawesome icons that I have now. I want to leave it in case I deal with replacing images
by its SRC again.

 A note for myself and others who read this.
